        ...
        <DialogContent className="max-w-sm">
          <div className="flex max-h-[85vh] flex-col gap-3 overflow-y-auto p-6">
            ...
            <button
              ...
              className="mt-1 self-start rounded-md bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground transition-colors hover:bg-primary/90 active:bg-primary/90 disabled:pointer-events-none disabled:opacity-50"
            >
